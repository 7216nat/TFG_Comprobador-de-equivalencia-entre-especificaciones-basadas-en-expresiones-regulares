...
public class Algoritmos {
	 ...
	 * @return
	 */
	public static Equivalencia detHopKarp(Automata at1, Automata at2, IdEstado idst, List<String> simb) {
 ...
 */
	private static void determinarEstado(int viejo, Automata afd, String simb, IdEstado idst, Automata at,
			Map<Integer, EstadoTh> aExplorar) {
...
//					return (nodo.getSimbolos() + s + ", no final aut1, final aut2");
	 ...
	 * @return
	 */
	public static Equivalencia detHopKarpSinLambda(Automata at1, Automata at2, IdEstado idst, List<String> simb) {
		Map<Integer, EstadoTh> aExplorar = new HashMap<>();
		Queue<SimEsEs> aComparar = new LinkedList<>();
		Estado inicial = at1.getIni();
		Estado inicial2 = at2.getIni();
