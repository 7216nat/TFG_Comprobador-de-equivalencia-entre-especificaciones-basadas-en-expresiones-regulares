...
public class ParserER {
	...
	// dado un puntero, concatenar todas las instancias de ExpressionBase posteriores
	// la CONCATENACIÓN está implicta en esta funcion 
	...
	// La idea de union y parentesis es que cada vez que ocurran, al terminar formen solo una ER
	private void parseDeVerdad(int ptrPila) {
		...
		while (terminado()) {
			if (prim() == '(') { // apertura de parentesis
				...
				// ***********conjunto vacio no está implementado**********
